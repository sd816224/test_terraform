from src.transformation_lambda.read_s3_json import (
    read_s3_json, get_object_path, get_content_from_file)
...
@patch('src.transformation_lambda.read_s3_json.get_content_from_file',
       return_value='{"c1": 1, "c2": 2}')
def test_read_s3_json(get_content_from_file):
    assert read_s3_json(test_event, 'context') == {"c1": 1, "c2": 2}
