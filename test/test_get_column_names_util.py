from src.loading_lambda.get_column_names_util import (
    get_column_names, get_connection, get_credentials)
import logging
...
def test_real_dim_counterparty_columns():
    ...
    assert result == "('counterparty_id', 'counterparty_legal_name', 'counterparty_legal_address_line_1', 'counterparty_legal_address_line_2', 'counterparty_legal_district', 'counterparty_legal_city', 'counterparty_legal_postal_code', 'counterparty_legal_country', 'counterparty_legal_phone_number')"  # noqa E501
...
def test_real_dim_design_columns():
    ...
    assert result == "('design_id', 'design_name', 'file_location', 'file_name')"  # noqa E501
...
def test_real_dim_location_columns():
    ...
    assert result == "('location_id', 'address_line_1', 'address_line_2', 'district', 'city', 'postal_code', 'country', 'phone')"  # noqa E501
...
def test_real_dim_staff_columns():
    ...
    assert result == "('staff_id', 'first_name', 'last_name', 'department_name', 'location', 'email_address')"  # noqa E501
